...
;; Interacting with the Interwebs.
...
(message "Loading Interwebs configuration.")

;; gist: create GitHub gists from Emacs.
(use-package gist
  :ensure t)

;; mm-url is built into Emacs (part of Gnus).
(require 'mm-url)
